...
for x in range(x,8976): 
	...
	filename = path+ "/one_hour_bars_4pm.csv"  	
	...
	getstring=f'https://api.polygon.io/v2/aggs/ticker/{ts}/range/1/hour/{today}/{today}?sort=desc&limit=100&apiKey=jg0i3J_ZFD1_v4wBRQFEzp9NHDlYwHQff5_8_u'
	print(getstring)
