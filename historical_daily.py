...
parser.add_argument('--ticker',  metavar="ticker", help='Ticker symbol', default=sym, required=False)
parser.add_argument('--dateEnd', metavar="dateE", type=as_date,  help='Ending Date', default=dt1, required=False)
parser.add_argument('--dateStart', metavar="dateS", type=as_date,  help='Starting Date', default=dt2, required=False)
