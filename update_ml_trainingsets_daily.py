...
parser.add_argument('--dateEnd', metavar="dateE", type=as_date,  help='Ending Date', default=ydate, required=False)
parser.add_argument('--dateStart', metavar="dateS", type=as_date,  help='Starting Date', default=ydate, required=False)
