...
#	sql = "select symbol from equities where symbol = 'AA'"
	...
	for y in result:
		...
		path_str = "/Volumes/ExtremePro/ml_trading_ext/tickers/" +symbol+ "/one_hour_bars/"
	#	path_str = "/Users/danielsavage/algos/tickers/" +symbol+ "/"
		...
		filename_str = path_str+ "one_hour_bars_" +dt1+ ".csv"  	
		...
		getstring=f'https://api.polygon.io/v2/aggs/ticker/{t}/range/1/hour/{dt1}/{dt2}?sort=asc&limit=30000&apiKey=jg0i3J_ZFD1_v4wBRQFEzp9NHDlYwHQff5_8_u'
		print(getstring)
