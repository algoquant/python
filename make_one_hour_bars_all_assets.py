...
#		sql = "select symbol from equities where symbol = 'AA'"
		...
		#	path_str = "/Users/danielsavage/algos/tickers/" +symbol+ "/"
			...
			filename_str = path_str+ "one_hour_bars" +zs+ ".csv"  	
			...
			getstring=f'https://api.polygon.io/v2/aggs/ticker/{t}/range/1/hour/{dt1}/{dt2}?sort=asc&limit=5000&apiKey=jg0i3J_ZFD1_v4wBRQFEzp9NHDlYwHQff5_8_u'
			print(getstring)
